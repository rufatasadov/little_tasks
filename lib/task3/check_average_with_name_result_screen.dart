...
class CheckAvegareWithNameResultScreen extends StatefulWidget {
  const CheckAvegareWithNameResultScreen({super.key});

  @override
  State<CheckAvegareWithNameResultScreen> createState() =>
      _CheckAvegareWithNameResultScreenState();
}

class _CheckAvegareWithNameResultScreenState
    extends State<CheckAvegareWithNameResultScreen> {
  List<int> _points = [];
  int _averagePoint = 0;
  String _studentName = '';
  String _resultText = '';
  ...
  void getResult() {
    ...
    final finalResult = switch (_averagePoint) {
      < 45 => 'Q-kafi kece bilmediniz',
      >= 45 && < 70 => 'Meqbul',
      >= 70 && < 90 => 'Yaxshi',
      >= 90 && <= 100 => 'Ela',
      _ => 'Wrong data'
    ...
    _resultText += 'Semestr Yekunu: $finalResult';
  }
